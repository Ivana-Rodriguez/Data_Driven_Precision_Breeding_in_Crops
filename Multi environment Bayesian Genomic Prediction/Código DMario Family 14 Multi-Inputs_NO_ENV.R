...
#####Loading data set#############
dataset_file="DMario_Family_14"
##load(paste0(dataset_file,".RData"))

Geno <- read.csv("C:/Users/Elías/Documents/Resultados y datos R_ Genomic Selection/Descarga de Datos Geno_Pheno/Geno % Pheno DMario Family 14/Geno_DMario_Family_14.csv")
Pheno <- read.csv("C:/Users/Elías/Documents/Resultados y datos R_ Genomic Selection/Descarga de Datos Geno_Pheno/Geno % Pheno DMario Family 14/Pheno_DMario_Family_14.csv")
...
Traits_to_evaluate=colnames(Pheno)[c(5:7)]
...
for (t in 1:length(Traits_to_evaluate)){
  ...
  for(i in seq_along(folds )) {
    ...
    ##########ETA1 con Env y Lines ==P1############## multi-inputs
    ETA1=list(
...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_DMario_Family_14_NO_ENV.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_DMario_Family_14_NO_ENV.csv"))
