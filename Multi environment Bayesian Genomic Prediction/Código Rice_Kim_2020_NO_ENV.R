...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Rice_Kim_2020_NO_ENV.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Rice_Kim_2020_NO_ENV.csv"))
