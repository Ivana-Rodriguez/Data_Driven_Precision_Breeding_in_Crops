...
#####Loading data set#############
dataset_file="Rice_IRRI_Philippines_Spindel_2015"
##load(paste0(dataset_file,".RData"))

Geno <- read.csv("C:/Users/Elías/Documents/Resultados y datos R_ Genomic Selection/Descarga de Datos Geno_Pheno/Geno % Pheno Rice IRRI Philippines 2015/Geno_Rice_IRRI_Philippines_Spindel_2015.csv")
Pheno <- read.csv("C:/Users/Elías/Documents/Resultados y datos R_ Genomic Selection/Descarga de Datos Geno_Pheno/Geno % Pheno Rice IRRI Philippines 2015/Pheno_Rice_IRRI_Philippines_Spindel_2015.csv")
...
Traits_to_evaluate=colnames(Pheno)[c(4:7,9:22)]
...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Rice_IRRI_Philippines_Spindel_2015_NO_ENV.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Rice_IRRI_Philippines_Spindel_2015_NO_ENV.csv"))
