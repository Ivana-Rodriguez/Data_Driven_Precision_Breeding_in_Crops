...
#####Loading data set#############
dataset_file="Winter_Wheat_Washington_2021"
##load(paste0(dataset_file,".RData"))

Geno <- read.csv("C:/Users/Elías/Documents/Resultados y datos R_ Genomic Selection/Descarga de Datos Geno_Pheno/Geno % Pheno Winter Wheat Washington 2021/Geno_2021_Winter_Wheat_Whashington_USA_Carter_2024.csv")
Pheno <- read.csv("C:/Users/Elías/Documents/Resultados y datos R_ Genomic Selection/Descarga de Datos Geno_Pheno/Geno % Pheno Winter Wheat Washington 2021/Pheno_2021_Winter_Wheat_Whashington_USA_Carter_2024.csv")
...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Winter_Wheat_Washington_2021_NO_ENV.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Winter_Wheat_Washington_2021_NO_ENV.csv"))
