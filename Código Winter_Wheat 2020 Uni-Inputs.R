...
Geno <- read.csv("C:/Users/Lenovo/Desktop/Osval/Unimodal/WHINTER_WHEAT_2020/Geno_2020_Winter_Wheat_Whashington_USA_Carter_2024.csv")
Pheno <- read.csv("C:/Users/Lenovo/Desktop/Osval/Unimodal/WHINTER_WHEAT_2020/Pheno_2020_Winter_Wheat_Whashington_USA_Carter_2024.csv")
...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Winter_Wheat_Washington_2020_ETA Lines.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Winter_Wheat_Washington_2020_ETA Lines.csv"))
