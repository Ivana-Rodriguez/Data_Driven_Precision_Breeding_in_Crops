...
Geno <- read.csv("C:/Users/Lenovo/Desktop/Osval/Unimodal/POTATO_SUECIA_RODOMIRO/Geno_Potato_Suecia_Rodomiro_Ortiz_2023.csv")
Pheno <- read.csv("C:/Users/Lenovo/Desktop/Osval/Unimodal/POTATO_SUECIA_RODOMIRO/Pheno_Potato_Suecia_Rodomiro_Ortiz_2023.csv")
...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Potato_Suecia_Rodomiro_Ortiz_2023_ETA Lines.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Potato_Suecia_Rodomiro_Ortiz_2023_ETA Lines.csv"))
