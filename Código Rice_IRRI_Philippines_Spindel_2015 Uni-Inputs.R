...
Geno <- read.csv("C:/Users/Lenovo/Desktop/Osval/Unimodal/RICE_IRRI_PHILIPINES/Geno_Rice_IRRI_Philippines_Spindel_2015.csv")
Pheno <- read.csv("C:/Users/Lenovo/Desktop/Osval/Unimodal/RICE_IRRI_PHILIPINES/Pheno_Rice_IRRI_Philippines_Spindel_2015.csv")
...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Rice_IRRI_Philippines_Spindel_2015_ETA Lines.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Rice_IRRI_Philippines_Spindel_2015_ETA Lines.csv"))
